import { LogOut, Menu, ShoppingCart, UserCog, LogIn } from "lucide-react";
import {
  Link,
  useLocation,
  useNavigate,
    ...
    <nav className="flex flex-col mb-3 lg:mb-0 lg:items-center gap-6 lg:flex-row ">
      {shoppingViewHeaderMenuItems.map((menuItem) => (
        <Label
          ...
          className={`text-md font-medium cursor-pointer hover:animate-pulse hover:bg-yellow-100 p-2 px-4 rounded-full ${
            location.pathname.split("/")[1] === menuItem.id
              ? "bg-yellow-200"
              : ""
          }`}
          key={menuItem.id}
